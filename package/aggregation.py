...
def filter_file_names_metabolites_genetic_scores(
    pattern=None,
    files=None,
):
    """
...
def extract_metabolite_identifiers_from_file_names(
    files=None,
):
    """
    ...
    arguments:
        files (list<str>): names of files with genetic scores for metabolites
    ...
    # Filter to names of files with genetic scores.
    files_scores = filter_file_names_metabolites_genetic_scores(
...
# a few things...
# 1. new cohorts
# --- alcoholism cases with valid AUDIT-C scores and testosterone...
# --- maybe just write a new function for the AUDIT-C alcoholism definition...
# --- allow this function options for alcoholism definition case and control
# ---
...
def execute_procedure(
    ...
    print(source["files"])
    # Extract metabolite identifiers from file names.
    metabolite_identifiers = extract_metabolite_identifiers_from_file_names(
        files=source["files"],
    )
