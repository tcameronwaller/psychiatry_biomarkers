...
# batch job: ____ (15 November 2023)
...
path_directory_source="${path_directory_dock}/gwas_preparation_ldsc_tcw_2023-11-13/4_filter_constrain_gwas_values"
path_directory_product="${path_directory_dock}/gwas_preparation_ldsc_tcw_2023-11-13/5_gwas_clean_gwas2vcf"
