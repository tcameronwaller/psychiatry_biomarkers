...
# batch job: 2445236 (2 instances; 30 November 2023)
...
path_directory_source="${path_directory_process}/test_williams_grch37/2_gwas_assembly_grch37"
path_directory_product="${path_directory_process}/test_williams_grch37/5_gwas_clean_gwas2vcf"
path_directory_batch="${path_directory_product}/batch"

# Files.
path_file_table_parameter="${path_directory_parameters}/table_gwas_translation_tcw_2023-11-26_test_williams.tsv"
