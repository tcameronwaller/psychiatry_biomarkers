...
path_directory_source_rescue="${path_directory_dock}/gwas_preparation_${identifier_preparation}/4_filter_constrain_gwas_values"
path_directory_source="${path_directory_dock}/gwas_preparation_${identifier_preparation}/5_gwas_clean_gwas2vcf"
path_directory_product="${path_directory_dock}/gwas_preparation_${identifier_preparation}/6_filter_constrain_gwas_values"
