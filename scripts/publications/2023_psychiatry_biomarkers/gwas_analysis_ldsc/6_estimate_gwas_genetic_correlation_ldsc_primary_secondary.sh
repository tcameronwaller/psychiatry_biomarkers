...
path_directory_product_parent="${path_directory_group_parent}/6_gwas_correlation_ldsc_primary_secondary"
...
# Thyroid physiology, sex hormones, and other biomarkers.
# Review: TCW; 9 January 2024
# Count of secondary studies and versions: 164
...
if [[ "$report" == "true" ]]; then
  ...
  echo "6_estimate_gwas_genetic_correlation_ldsc_primary_secondary.sh"
  echo "----------"
fi
