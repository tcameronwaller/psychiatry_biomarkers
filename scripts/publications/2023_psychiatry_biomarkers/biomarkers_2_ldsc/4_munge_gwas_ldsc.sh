...
path_directory_source="${path_directory_dock}/ldsc_gwas_biomarkers_tcw_2023-09-29/3_gwas_format_ldsc"
path_directory_product="${path_directory_dock}/ldsc_gwas_biomarkers_tcw_2023-09-29/4_gwas_munge_ldsc"
