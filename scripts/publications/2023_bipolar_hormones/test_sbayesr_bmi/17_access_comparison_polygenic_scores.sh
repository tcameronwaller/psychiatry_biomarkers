...
path_directory_scores_ldpred2=$(<"./scores_mayo_bipolar_1_2_merge_mayo_control_ldpred2.txt") # cases from Mayo Bipolar 1-2-Merge and controls from Mayo Clinic Biobank
path_directory_scores_ldpred2_2=$(<"./scores_mayo_bipolar_1_2_merge_mayo_control_ldpred2_2.txt") # cases from Mayo Bipolar 1-2-Merge and controls from Mayo Clinic Biobank
path_directory_scores_prsice2=$(<"./scores_mayo_bipolar_1_2_merge_mayo_control_prsice2.txt") # cases from Mayo Bipolar 1-2-Merge and controls from Mayo Clinic Biobank
...
# Files.
path_file_source_ldpred2="${path_directory_source_ldpred2}/BMI_GIANTUKB_EUR.LDpred2.auto.gz" # Source file has GZip compression.
path_file_source_ldpred2_2="${path_directory_source_ldpred2_2}/BMI_GIANTUKB_EUR.LDpred2.auto.gz" # Source file has GZip compression.
path_file_source_prsice2="${path_directory_source_prsice2}/BMI_GIANTUKB_EUR.all_score" # Source file does not have compression.
#path_file_source_prsice2="${path_directory_source_prsice2}/BMI_GIANTUKB_EUR.best.gz" # Best has algorithmic bias and fewer SNPs.
...
cp $path_file_source_prsice2 $path_file_product_prsice2
