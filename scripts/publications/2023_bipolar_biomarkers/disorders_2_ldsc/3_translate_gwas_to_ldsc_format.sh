...
path_directory_source="${path_directory_dock}/ldsc_gwas_disorders_tcw_2023-08-02/1_gwas_summaries_source"
path_directory_product="${path_directory_dock}/ldsc_gwas_disorders_tcw_2023-08-02/3_gwas_format_ldsc"
