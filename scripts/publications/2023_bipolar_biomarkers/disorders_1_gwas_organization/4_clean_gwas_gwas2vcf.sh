...
path_directory_source="${path_directory_dock}/gwas_disorders_tcw_2023-08-02/3_gwas_allele_frequency"
path_directory_product="${path_directory_dock}/gwas_disorders_tcw_2023-08-02/4_gwas_clean_gwas2vcf"
# Files.
