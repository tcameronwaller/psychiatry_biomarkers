...
path_directory_source="${path_directory_dock}/gwas_biomarkers_tcw_2023-05-25/gwas_munge_ldsc"
path_directory_product="${path_directory_dock}/gwas_biomarkers_tcw_2023-05-25/gwas_heritability_ldsc"
