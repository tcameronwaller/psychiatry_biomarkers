...
path_directory_product_parent="${path_directory_dock}/gwas_biomarkers_ldsc_tcw_2023-05-25"
path_directory_product_child="${path_directory_product_parent}/${name_source_directory}"
path_directory_product="${path_directory_dock}/gwas_biomarkers_ldsc_tcw_2023-05-25/gwas_summaries_source"
