...
path_directory_source="${path_directory_dock}/gwas_biomarkers_tcw_2023-09-19/1_gwas_format_standard_test"
path_directory_product="${path_directory_dock}/gwas_biomarkers_tcw_2023-09-19/2_gwas_assembly_grch37_test"
# Files.
