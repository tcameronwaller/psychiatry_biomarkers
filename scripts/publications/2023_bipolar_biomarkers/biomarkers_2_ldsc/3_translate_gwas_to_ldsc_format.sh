...
path_directory_source="${path_directory_dock}/ldsc_gwas_biomarkers_tcw_2023-06-06/1_gwas_summaries_source"
path_directory_product="${path_directory_dock}/ldsc_gwas_biomarkers_tcw_2023-06-06/3_gwas_format_ldsc"
