...
path_directory_source="${path_directory_dock}/gwas_biomarkers_tcw_2023-05-25/2_gwas_assembly_grch37"
path_directory_product="${path_directory_dock}/gwas_biomarkers_tcw_2023-05-25/3_gwas_allele_frequency"
# Files.
# Scripts.
