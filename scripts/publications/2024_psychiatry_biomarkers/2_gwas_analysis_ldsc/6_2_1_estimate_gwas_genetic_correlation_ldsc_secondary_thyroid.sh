...
# On 14 March 2024, TCW changed the name of this script's file to
# "6_estimate_gwas_genetic_correlation_ldsc_secondary_thyroid.sh", and on
# 14 March 2024, TCW also changed the name of the
# "path_directory_product_parent" directory to
# "6_gwas_correlation_ldsc_secondary_thyroid". The purpose of these changes was
# to clarify that this group of genetic correlations amongst secondary studies
# only included those relevant to thyroid disorders and thyroid physiology.
...
path_directory_product_parent="${path_directory_group_parent}/6_gwas_correlation_ldsc_secondary_thyroid"
