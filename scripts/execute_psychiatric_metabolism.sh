...
#python3 $path_package/interface.py main --path_dock $path_dock --importation # TCW 23 November 2021
#python3 $path_package/interface.py main --path_dock $path_dock --organization # TCW 17 December 2021
python3 $path_package/interface.py main --path_dock $path_dock --stratification # TCW 17 December 2021
