...
#python3 $path_package/interface.py bipolar_biobank --path_dock $path_dock --organization # TCW; 15 June 2022
python3 $path_package/interface.py bipolar_biobank --path_dock $path_dock --regression # TCW; 15 June 2022
