...
#python3 $path_package/interface.py stragglers --path_dock $path_dock --mbpdb_assembly # TCW; 13 September 2022
python3 $path_package/interface.py stragglers --path_dock $path_dock --mbpdb_organization # TCW; 13 September 2022
#python3 $path_package/interface.py stragglers --path_dock $path_dock --mbpdb_regression # TCW; 7 September 2022
