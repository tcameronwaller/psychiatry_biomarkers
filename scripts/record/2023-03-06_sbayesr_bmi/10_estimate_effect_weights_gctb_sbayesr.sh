...
path_directory_product="${path_directory_dock}/test_sbayesr_body_mass_tcw_2023-03-01/effect_weights_sbayesr"
...
path_file_gwas_product="${path_directory_product}/BMI_GIANTUKB_EUR.ma"
...
name_file_product_suffix="_tcw_2023-03-01" # Suffix must not be an empty string.
