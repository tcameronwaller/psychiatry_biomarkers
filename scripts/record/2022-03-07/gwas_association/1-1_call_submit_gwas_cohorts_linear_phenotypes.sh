...
#path_gwas_container="${path_dock}/gwas_raw/oestradiol_logistic"   # 24 GWAS; TCW started at 16:51 on 01 March 2022; job 3202343; status: running; several jobs were killed due to exceeding 1 day;
