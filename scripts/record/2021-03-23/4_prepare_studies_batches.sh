...
#path_correlation_yengo_2018="${path_genetic_correlation}/30124842_yengo_2018"
#path_correlation_pulit_2018="${path_genetic_correlation}/30239722_pulit_2018"
...
path_script_gwas_organization="${path_scripts}/7_organize_gwas_ldsc_33437055_panyard_2021.sh"
# Prepare and submit batch.
/usr/bin/bash "$path_scripts/4_prepare_submit_batch_organize_gwas_heritability.sh" \
$path_source \
