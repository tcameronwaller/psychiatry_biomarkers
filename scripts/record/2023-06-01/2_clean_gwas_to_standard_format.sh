...
path_directory_source="${path_directory_dock}/hormone_genetics_tcw_2023-02-17/gwas_format_standard"
path_directory_product="${path_directory_dock}/hormone_genetics_tcw_2023-02-17/gwas_vcf_process"
#path_directory_product="${path_directory_dock}/hormone_genetics/gwas_vcf_hormones"
# Files.
path_file_translation="${path_directory_parameters}/table_gwas_translation_tcw_2023-02-17.tsv"
# Scripts.
