...
#path_directory_source="${path_dock}/hormone_genetics/gwas_munge_ldsc"
path_directory_source="${path_directory_dock}/test_compare_gwas2vcf_in_ldsc/gwas_munge_ldsc"
#path_directory_product="${path_dock}/hormone_genetics/gwas_heritability_ldsc"
path_directory_product="${path_dock}/test_compare_gwas2vcf_in_ldsc/gwas_heritability_ldsc"
