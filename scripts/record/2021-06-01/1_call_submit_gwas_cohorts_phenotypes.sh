...
cohorts_models+=("bipolar_disorder_case;table_bipolar_disorder_case;sex,age,")
cohorts_models+=("white_bipolar_disorder_case;table_white_bipolar_disorder_case;sex,age,")
cohorts_models+=("bipolar_disorder_control;table_bipolar_disorder_control;sex,age,")
cohorts_models+=("white_bipolar_disorder_control;table_white_bipolar_disorder_control;sex,age,")

cohorts_models+=("bipolar_disorder_case_simple;table_bipolar_disorder_case;sex,")
cohorts_models+=("white_bipolar_disorder_case_simple;table_white_bipolar_disorder_case;sex,")
cohorts_models+=("bipolar_disorder_control_simple;table_bipolar_disorder_control;sex,")
cohorts_models+=("white_bipolar_disorder_control_simple;table_white_bipolar_disorder_control;sex,")

cohorts_models+=("bipolar_disorder_case_unadjust;table_bipolar_disorder_case;")
cohorts_models+=("white_bipolar_disorder_case_unadjust;table_white_bipolar_disorder_case;")
cohorts_models+=("bipolar_disorder_control_unadjust;table_bipolar_disorder_control;")
