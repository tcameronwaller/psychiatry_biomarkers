...
#path_gwas_container="${path_dock}/gwas_raw/white_female_linear"                    # 8 GWAS; TCW started at ___ on 01 February 2022
path_gwas_container="${path_dock}/gwas_raw/white_male_linear"                      # 8 GWAS; TCW started at ___ on 01 February 2022
