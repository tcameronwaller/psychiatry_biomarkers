...
path_directory_parent_source="${path_directory_gwas_summaries}/test_test_test"
path_dock="${path_directory_process}/dock"
path_parameters="${path_dock}/parameters/psychiatric_metabolism"
...
# Parameters.
path_file_translation="${path_parameters}/table_gwas_translation_tcw_2022-12-22_test.tsv"
