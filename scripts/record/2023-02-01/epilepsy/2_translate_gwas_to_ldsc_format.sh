...
path_directory_source="${path_directory_dock}/epilepsy/gwas_format_standard"
path_directory_product="${path_directory_dock}/epilepsy/gwas_format_ldsc"
# Files.
...
if [[ "$report" == "true" ]]; then
  ...
  echo "2_translate_gwas_to_ldsc_format.sh"
  echo "----------"
fi
