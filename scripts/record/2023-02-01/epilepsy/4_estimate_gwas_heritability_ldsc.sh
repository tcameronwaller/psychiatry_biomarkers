...
path_directory_product="${path_directory_dock}/epilepsy/gwas_heritability_ldsc"
...
path_file_script="${path_directory_promiscuity_scripts}/utility/ldsc/estimate_gwas_heritability_ldsc.sh"
...
if [[ "$report" == "true" ]]; then
  ...
  echo "4_estimate_gwas_heritability_ldsc.sh"
  echo "----------"
fi
