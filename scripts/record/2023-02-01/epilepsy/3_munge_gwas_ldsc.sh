...
path_directory_source="${path_directory_dock}/epilepsy/gwas_format_ldsc"
path_directory_product="${path_directory_dock}/epilepsy/gwas_munge_ldsc"
...
path_file_script="${path_directory_promiscuity_scripts}/utility/ldsc/munge_gwas_ldsc.sh"
