...
path_directory_source="${path_directory_dock}/hormone_genetics_tcw_2023-02-22/gwas_format_standard"
path_directory_product="${path_directory_dock}/hormone_genetics_tcw_2023-02-22/gwas_vcf_process"
