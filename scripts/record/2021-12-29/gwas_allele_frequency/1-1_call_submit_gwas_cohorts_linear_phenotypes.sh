...
path_stratification_tables="${path_dock}/stratification/body_bipolar_linear"
#path_stratification_tables="${path_dock}/stratification/body_bipolar_logistic"

path_gwas_container="${path_dock}/gwas_raw/body_white_bipolar_strict_linear"          # 12 GWAS; TCW started at ___ on 17 December 2021
#path_gwas_container="${path_dock}/gwas_raw/body_white_bipolar_strict_logistic"          # 12 GWAS; TCW started at ___ on 17 December 2021
...
cohorts_models_instances+=("white_bipolar_strict_control_sex;table_white_bipolar_strict_control;sex,")
cohorts_models_instances+=("white_bipolar_strict_control_sex_age;table_white_bipolar_strict_control;sex,age,")
cohorts_models_instances+=("white_bipolar_strict_case_unadjust;table_white_bipolar_strict_case;")
cohorts_models_instances+=("white_bipolar_strict_case_sex;table_white_bipolar_strict_case;sex,")
cohorts_models_instances+=("white_bipolar_strict_case_sex_age;table_white_bipolar_strict_case;sex,age,")
...
phenotypes_instances+=("body;body;body")
phenotypes_instances+=("body_log;body;body_log")
...
for cohort_model_instance in "${cohorts_models_instances[@]}"; do
  ...
  for phenotype_instance in "${phenotypes_instances[@]}"; do
    ...
    table_phenotypes_covariates="${table_cohort_prefix}_${table_phenotype_suffix}.tsv" # name of table of phenotypes and covariates
